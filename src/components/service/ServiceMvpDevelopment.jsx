    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 px-4 items-stretch relative z-10">
        ...
        >
          ...
          >
            Our Professional developers designers work together to build world
            class MVP that offer great user experiences. We focus on MVP
            development, making sure your product is easy to find and ready for
            market testing. After launching an MVP, you can gradually add
            features until it becomes a complete app.
          </motion.p>
